...
## Test Cases
The project includes positive and negative test cases designed to validate different login scenarios.The test cases cover login attempts,invalid credentials and expected system behavior when incorrect data is provided.
## Bug Reports
